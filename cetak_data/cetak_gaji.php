...
<head>
    ...
    <title>Print Gaji Pegawai</title>
...
<div id="content book">
    ...
    <div class="page">
        ...
        <div class="title mt-5 text-center">
            <h3>LAPORAN DATA Gaji Pegawai</h3>
        </div>
            ...
            <table class="table table-bordered">
                ...
                <?php
                    ...
                    if(isset($_GET['id'])){
                        ...
                        WHERE riwayat_gaji.id_rgaji='$id'");
                        while($row = mysqli_fetch_assoc($sqldvsi))
                    ...
                    elseif(@$_GET['jenis']){
                        ...
                        INNER JOIN data_pegawai ON riwayat_gaji.id_pegawai = data_pegawai.id_pegawai
                        INNER JOIN pangkat ON data_pegawai.id_pangkat = pangkat.id_pangkat
                        WHERE data_pegawai.jenis='$jenis'");
