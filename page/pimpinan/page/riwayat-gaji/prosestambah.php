...
$waktu_gajian = $_POST['waktu_gajian'];
...
$jumlah_kotor = ((int)$gaji_pokok + (int)$t_istri + (int)$t_anak + (int)$t_umum + (int)$t_struktur +
...
$gaji_bersih = $jumlah_kotor - $jumlah_potongan;
    ...
    VALUES('$idgaji','$id_pegawai','$waktu_gajian','$gaji_pokok','$t_istri','$t_anak','$t_umum','$t_struktur','$t_fungsi'
